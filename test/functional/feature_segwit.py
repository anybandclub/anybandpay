...
from test_framework.abpconfig import INITIAL_BLOCK_REWARD
from test_framework.abp import convert_btc_address_to_abp
...
class SegWitTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        uncompressed_spendable_address = [convert_btc_address_to_abp("mvozP4UwyGD2mGZU4D2eMvMLPB9WkMmMQu")]
        self.nodes[0].importprivkey("cNC8eQ5dg3mFAVePDX4ddmPYpPbw41r9bm2jd1nLJT77e6RrzTRR")
        compressed_spendable_address = [convert_btc_address_to_abp("mmWQubrDomqpgSYekvsU7HWEVjLFHAakLe")]
        ...
        unknown_address = [convert_btc_address_to_abp("mtKKyoHabkk6e4ppT7NaM7THqPUt7AzPrT"), convert_btc_address_to_abp("2NDP3jLWAFT8NDAiUa9qiE6oBt2awmMq7Dx")]
        ...
        unsolvable_address = [convert_btc_address_to_abp("mjoE3sSrb8ByYEvgnC3Aox86u1CHnfJA4V"), convert_btc_address_to_abp("2N7MGY19ti4KDMSzRfPAssP6Pxyuxoi6jLe"), script_to_p2sh(op1), script_to_p2sh(op0)]
        ...
        uncompressed_spendable_address = [convert_btc_address_to_abp("mguN2vNSCEUh6rJaXoAVwY3YZwZvEmf5xi")]
        self.nodes[0].importprivkey("cMcrXaaUC48ZKpcyydfFo8PxHAjpsYLhdsp6nmtB3E2ER9UUHWnw")
        compressed_spendable_address = [convert_btc_address_to_abp("n1UNmpmbVUJ9ytXYXiurmGPQ3TRrXqPWKL")]
        ...
        for use_p2wsh in [False, True]:
            if use_p2wsh:
                scriptPubKey = "00203a59f3f56b713abpf5d1a57357f02c44342cbf306ffe0c4741046837bf90561a"
                transaction = "01000000000100e1f505000000002200203a59f3f56b713abpf5d1a57357f02c44342cbf306ffe0c4741046837bf90561a00000000"
            else:

...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ABP");
    case mBTC: return QString("mABP");
    case uBTC: return QString::fromUtf8("μABP");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Abps");
    case mBTC: return QString("Milli-Abps (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Abps (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}

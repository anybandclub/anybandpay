#ifndef ABPVERSIONCHECKER_H
#define ABPVERSIONCHECKER_H

#include <QObject>

#define ABP_RELEASES "https://github.com/abpproject/abp/releases"
...
class AbpVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit AbpVersionChecker(QObject *parent = 0);
    ~AbpVersionChecker();

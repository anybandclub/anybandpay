...
const char * const BITCOIN_CONF_FILENAME = "abp.conf";
const char * const BITCOIN_PID_FILENAME = "abpd.pid";
...
bool OpenDebugLog()
{
    ...
    assert(fileoutVM == nullptr); // abp
    assert(vMsgsBeforeOpenLog);
    fs::path pathDebug = GetDebugLogPath();
    fs::path pathDebugVM = GetDebugVMLogPath(); // abp
    fileout = fsbridge::fopen(pathDebug, "a");
    fileoutVM = fsbridge::fopen(pathDebugVM, "a"); // abp
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Abp";
#else
    // Unix
    return pathRet / ".abp";
#endif
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Abp Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Abp Core developers";
    }

...
////////////////////////////////////////////////////////////// // abp
	void setAbpSchedule(EVMSchedule _abpSchedule) const { abpSchedule = _abpSchedule; }

	EVMSchedule& getAbpSchedule() const { return abpSchedule; }
...
private:
	...
	mutable EVMSchedule abpSchedule; // abp

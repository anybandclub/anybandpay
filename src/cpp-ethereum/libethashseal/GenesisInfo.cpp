...
#include "genesis/abpMainNetwork.cpp"
#include "genesis/abpTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::abpMainNetwork: return c_genesisInfoAbpMainNetwork;
	case Network::abpTestNetwork: return c_genesisInfoAbpTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::abpMainNetwork: return c_genesisStateRootAbpMainNetwork;
	case Network::abpTestNetwork: return c_genesisStateRootAbpTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}

...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // abp
        hashUTXORoot.SetNull(); // abp
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //abp
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //abp
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //abp
    {

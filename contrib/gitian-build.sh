...
VERSION=
commit=false
url=https://github.com/abpproject/abp
ethurl=https://github.com/abpproject/cpp-eth-abp
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/abpproject/abp
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit abp=${COMMIT},cpp-eth-abp=develop --url abp=${url},cpp-eth-abp=${ethurl} ../abp/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit abp=${COMMIT},cpp-eth-abp=develop --url abp=${url},cpp-eth-abp=${ethurl} ../abp/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit abp=${COMMIT},cpp-eth-abp=develop --url abp=${url},cpp-eth-abp=${ethurl} ../abp/contrib/gitian-descriptors/gitian-osx.yml
...
then
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -i --commit signature=master ../abp/contrib/gitian-descriptors/gitian-osx-signer.yml
